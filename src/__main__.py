...
from i3_gateway.config import load_config, Settings
...
def handle_signal(sig: int, gateway: Optional[I3Gateway]) -> None:
...
@click.option(
    "--dry-run",
    is_flag=True,
    help="Validate configuration without starting the gateway"
)
