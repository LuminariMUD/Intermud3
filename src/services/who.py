...
from ..models.packet import (
    I3Packet, PacketType, WhoPacket, PacketValidationError
)
...
class WhoService(BaseService):
    ...
    async def _handle_who_request(self, packet: WhoPacket) -> Optional[I3Packet]:
    ...
    async def _handle_who_reply(self, packet: WhoPacket) -> Optional[I3Packet]:
    ...
    async def _get_online_users(self, filter_criteria: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    async def send_who_request(self, target_mud: str, 
