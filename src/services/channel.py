...
from ..models.packet import (
    I3Packet, PacketType, PacketValidationError
)
...
class ChannelService(BaseService):
    ...
    async def handle_packet(self, packet: I3Packet) -> Optional[I3Packet]:
        ...
        elif packet_type == PacketType.CHANNEL_E:
            return await self._handle_channel_emote(packet)
        elif packet_type == PacketType.CHANNEL_T:
            return await self._handle_channel_targeted_emote(packet)
        elif packet_type == PacketType.CHANNEL_ADD:
            return await self._handle_channel_add(packet)
        elif packet_type == PacketType.CHANNEL_REMOVE:
            return await self._handle_channel_remove(packet)
        elif packet_type == PacketType.CHANNEL_ADMIN:
            return await self._handle_channel_admin(packet)
        elif packet_type == PacketType.CHANNEL_FILTER:
            return await self._handle_channel_filter(packet)
        elif packet_type == PacketType.CHANNEL_WHO:
            return await self._handle_channel_who(packet)
        elif packet_type == PacketType.CHANNEL_LISTEN:
            return await self._handle_channel_listen(packet)
        elif packet_type == PacketType.CHANLIST_REPLY:
            return await self._handle_chanlist_reply(packet)
        
        return None
    
    async def _handle_channel_message(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_emote(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_targeted_emote(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_add(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_remove(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_admin(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_filter(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_who(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_channel_listen(self, packet: I3Packet) -> Optional[I3Packet]:
    ...
    async def _handle_chanlist_reply(self, packet: I3Packet) -> Optional[I3Packet]:
        ...
        self.logger.info(
            ...
            chanlist_id=chanlist_id,
            channel_count=len(chanlist)
        )
    ...
    async def _check_filters(self, channel_name: str, mud_name: str, 
                            message: str) -> bool:
    ...
    async def _broadcast_to_local_subscribers(self, channel_name: str, 
                                             packet: I3Packet):
    ...
    async def send_channel_message(self, channel: str, user: str, 
                                  message: str, visname: Optional[str] = None) -> bool:
