...
from .mudmode import MudModeStreamProtocol, MudModeError
...
class ConnectionManager:
    ...
    def __init__(self, 
        ...
        self.current_router: Optional[RouterInfo] = None
        self.protocol: Optional[MudModeStreamProtocol] = None
    ...
    def get_current_router(self) -> Optional[RouterInfo]:
...
class ConnectionPool:
    ...
    def get_connection(self) -> Optional[ConnectionManager]:
