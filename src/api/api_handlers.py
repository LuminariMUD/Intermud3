...
class APIHandlers:
    ...
    async def handle_channel_emote(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def handle_channel_leave(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if filter_opts:
            ...
            for channel in channels:
                ...
                if "owner" in filter_opts and channel.get("owner") != filter_opts["owner"]:
                    continue
                if "min_members" in filter_opts and channel.get("member_count", 0) < filter_opts["min_members"]:
                    continue
    ...
    async def handle_channel_history(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
