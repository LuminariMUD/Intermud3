    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            await self.log_request(
                session, "who", params, users is not None,
...
class FingerHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "finger", params, info is not None,
...
class LocateHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "locate", params, locations is not None,
            ...
            if locations is not None:
                ...
                return {
                    "status": "failed",
                    "message": f"Could not complete locate for {target_user}"
                }
...
class MudListHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "mudlist", params, mudlist is not None,
            ...
            if mudlist is not None:
                ...
                return {
                    "status": "failed",
                    "message": "Could not retrieve MUD list"
                }
