    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            await self.log_request(
                session, "tell", params, success,
                None if success else "Failed to send tell"
            )
            ...
            if success:
                ...
                return {
                    "status": "failed",
                    "message": "Failed to deliver tell"
                }
        
        # Gateway not available
        return {
            "status": "queued",
            "message": "Tell queued for delivery"
        }
...
class EmoteToHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "emoteto", params, success,
                None if success else "Failed to send emote"
            )
            ...
            if success:
                ...
                return {
                    "status": "failed",
                    "message": "Failed to deliver emote"
                }
        
        return {
            "status": "queued",
            "message": "Emote queued for delivery"
        }
...
class ChannelSendHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "channel_send", params, success,
        ...
        return {
            "status": "queued",
            "message": "Channel message queued"
        }
...
class ChannelEmoteHandler(BaseHandler):
    ...
    async def handle(self, session: Session, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.gateway:
            ...
            # Log request
            await self.log_request(
                session, "channel_emote", params, success,
            ...
            if success:
                return {
                    "status": "success",
                    "message": "Channel emote sent",
                    "channel": channel
                }
            else:
                return {
                    "status": "failed",
                    "message": "Failed to send channel emote"
                }
        
        return {
            "status": "queued",
            "message": "Channel emote queued"
        }