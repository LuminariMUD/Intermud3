...
class TestEventBridge:
    ...
    async def test_process_channel_message_packet(self, bridge):
        ...
        packet = ChannelMessagePacket(**packet_data, channel="chat", visname="Alice", message="Hello everyone!")
    ...
    async def test_process_error_packet(self, bridge):
        ...
        packet = ErrorPacket(**packet_data, error_code="unk-user", error_message="Unknown user", bad_packet=[])
...
class TestEventBridgeIntegration:
    ...
    async def test_packet_processing_flow(self, bridge):
        ...
        channel_packet = ChannelMessagePacket(**channel_packet_data, channel="chat", visname="Alice", message="Hi all!")
